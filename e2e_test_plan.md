...
- [ ] **Scenario 1.1: Login with Valid Credentials**
    - **Status**: PASSED (Verified via regression batch 1)
...
- [ ] **Scenario 2.0: Manage Categories**
    - **Status**: PASSED (Verified creation of 'RegTest Category 2')
...
- [ ] **Scenario 2.2: Create a Product**
    - **Status**: PASSED (Verified creation of 'RegTest Product 2')
...
- [ ] **Scenario 3.1: Create Location Hierarchy**
    - **Status**: PASSED (Verified creation of 'RegTest Zone 2')
...
- [x] **Scenario 4.2: Allocate Order**
    - **Status**: PASSED (Verified via API Script - Stock moved to 'Stock' location, allocation logic confirmed)
...
- [ ] **Scenario 4.4: Verify Stock Reservation**
...
- [ ] **Scenario 5.5: Generate IWT Automatically from a Sales Order**  
    - **Status**: PASSED (Verified via API Script)
...
- [ ] **Scenario 9.1: Create & Process Return**
...
- [ ] **Scenario 9.2: Return to Quarantine**
    - **Status**: PASSED (Verified via API Script)
...
- [ ] **Scenario 10.1: Create Cycle Count Session**
