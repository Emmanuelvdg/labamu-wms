...
// The exact string without newlines, using a regex with whitespace tolerance
...
const searchRegex = /<\/CardContent>[\s\r\n]*<\/Card>[\s\r\n]*<\/div>[\s\r\n]*<\/section>/;

if (searchRegex.test(content)) {
    content = content.replace(searchRegex, replacement + "\\n                    </section>");
    fs.writeFileSync(filePath, content, 'utf8');
    console.log("Successfully updated page.tsx forcefully");
} else {
